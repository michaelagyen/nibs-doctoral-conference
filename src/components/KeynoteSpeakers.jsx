// src/components/KeynoteSpeakers.jsx
...
const KeynoteSpeakers = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `radial-gradient(circle at 30% 70%, rgba(34, 211, 238, 0.1), transparent 50%)`,
      }}
    >
      {/* Subtle tech overlay */}
          ...
          {speakers.map((speaker, index) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-300 text-base md:text-lg">{speaker.affiliation}</p>
